// ==UserScript==
// @name         Suno Song Renamer Elite (v2.4)
// @namespace    http://tampermonkey.net/
// @version      2.4
// @description  Blue Rename button, stable filter-based injection.
...
                <b style="color:#3b82f6;">BATCH RENAMER v2.4</b>
...
                item.onclick = () => {
                    document.getElementById(type === 'm' ? 'match-input' : 'replace-input').value = item.innerText;
...
        // Find button that contains the text "Filters"
...
            <div class="history-chip" data-idx="${i}">
                ${x.m.substring(0,8)}... → ${x.r.substring(0,8)}...
            </div>
        `).join('');
...
    // Logic for Renaming (Identical to v2.3)
